...
type View = "chat" | "settings" | "diagnostic";
  ...
  return (
    <div className="flex flex-col h-screen bg-base-100 text-base-content">
      ...
      <header className="flex items-center justify-between px-4 py-2 border-b border-base-300 shrink-0">
        <button
          className="text-lg font-light text-base-content/40 hover:text-base-content/60 transition-colors"
        ...
        <div className="flex items-center gap-1">
          {/* Diagnostic button */}
          <button
            className={`btn btn-ghost btn-sm btn-square ${view === "diagnostic" ? "text-primary" : "text-base-content/30"}`}
          ...
          {/* Settings button */}
          <button
            className={`btn btn-ghost btn-sm btn-square ${view === "settings" ? "text-primary" : "text-base-content/30"}`}
